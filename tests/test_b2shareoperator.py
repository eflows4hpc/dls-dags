...
from b2shareoperator import (B2ShareOperator, download_file,
...
class B2ShareOperatorTest(unittest.TestCase):
    ...
    def test_alt_execute_no_trigger(self, down, gfl, ht):
        ...
        dagrun = self.dag.create_dagrun(state=DagRunState.RUNNING, run_type=DagRunType.MANUAL,execution_date=days_ago(1) )
